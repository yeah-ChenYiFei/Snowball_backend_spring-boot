    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/articles/published").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/articles/*").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/articles/by-world/*").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/novels/published").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/novels/by-world/*").permitAll()
