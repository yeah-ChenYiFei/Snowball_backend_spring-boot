...
public class GroupMessageServiceImpl implements GroupMessageService {
    ...
    public void deleteMessage(Long groupId, Long messageId, Long userId, boolean isAdmin) {
        ...
        // Admin can delete any message; normal users can only delete their own
    ...
    private GroupMessageVO toVO(GroupMessage m) {
        ...
        userRepository.findById(m.getSenderId()).ifPresent(user -> vo.setSenderName(user.getUsername()));
        return vo;
    }
}
